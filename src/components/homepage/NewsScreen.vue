            ...
            <div class="velo_section_title">
                ...
                <div class="flex items-center justify-end news_icons">
                    <button title="Новини" class="news_btn_icon news_btn" @click="chooseNewsType('news')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="stroke-gray-400 hover:stroke-emerald-600">
                    ...
                    <button title="Події" class="news_btn_icon action_btn" @click="chooseNewsType('action')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class=" stroke-gray-400 hover:stroke-amber-500">
                    ...
                    <button title="Відео" class="news_btn_icon video_btn" @click="chooseNewsType('video')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class=" stroke-gray-400 hover:stroke-red-500">
                    ...
                    <button title="Статті" class="news_btn_icon blog_btn" @click="chooseNewsType('blog')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class=" stroke-gray-400 hover:stroke-sky-500">
