    ...
    <div class="w-full about_section">
        ...
        <div class="about_cont bg-emerald-600">
            <div class="about_texts">
                ...
                <div>Неформальна спільнота велосипедистів міста Вараш та громади.</div>
                <br>
                <div>Основні завдання:
                    <ul>
                        <li>пропагування здорового способу життя та сприяння розвитку велосипедного руху, спорту та туризму, особливо серед молоді;</li>
                        <li>сприяння розвитку велоінфраструктури;</li>
                        <li>дослідження, розробка, класифікація та маркування велосипедних маршрутів;</li>
                        <li>організація й проведення зустрічей, акцій, квестів, марафонів, змагань;</li>
                        <li>і так далі...</li>
                    </ul>
