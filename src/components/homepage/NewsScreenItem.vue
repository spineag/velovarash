...
const classColor = computed(() => ({
    'bg-emerald-600': props.newsItem.type=='news', 
    'bg-amber-500': props.newsItem.type=='action', 
    'bg-red-500': props.newsItem.type=='video', 
    'bg-sky-500': props.newsItem.type=='blog'
}))
    ...
    <div class="news_item velo_shadow" @mouseenter="isHover = true" @mouseleave="isHover = false">
       <div class="news_item_img"> </div>
        <div class="news_item_texts">
            <div class="news_item_type" :class="classColor">
