...
export const useHelpsStore = defineStore('helpsStore', () => {
    ...
    const helps = ref([
        {id:1, name:'Володимир', phone:'099 996 89 89', ava:'https://cdn-icons-png.flaticon.com/256/5556/5556468.png', 
            bg:url+'repair1.jpg',
            list:['Рихтування гака заднього перемикача', 'Заміна вилки', "Обмотка руля", "Підрізка руля", "Чищення ланцюга", "Чищення трансмісії"]},
        ...
        {id:8, name:'Михасько', phone:'068 676 32 65', ava:'https://cdn-icons-png.flaticon.com/256/5556/5556458.png', 
            bg:url+'repair7.jpg',
            list:['Антигравійка', 'Сервіс гальм', "Обмотка руля", "Збірка колеса", "Чищення ланцюга", "Чищення трансмісії", "Заміна гріпс", "Сервіс моноблоків", 'Налаштування гальм']},
    ]);
